...
import { useGetTransactionsQuery } from "@/service/api/semiFinishedGoodTransactionApiSlice";
...
const SemiFinishedTransactionHistory: React.FC<Props> = ({ id }) => {
    ...
    const limit = 10;
    const { data, error, isLoading } = useGetTransactionsQuery({ page, limit, search: '', semiFinishedGoodId: id ?? '' });
