...
const PrintColorDetailDialog: React.FC<Props> = ({ isOpen, onClose, initialData }) => {
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Portal>
        ...
        <Dialog.Positioner>
          <Dialog.Content>
            <Dialog.Header>
              <Dialog.Title>Thông Tin Màu In</Dialog.Title>
            </Dialog.Header>
            <Dialog.Body>
              <DataList.Root orientation="horizontal" divideY="1px" maxW="md">
                <DataList.Item pt="4">
                  <DataList.ItemLabel>Mã Màu In</DataList.ItemLabel>
...
export default PrintColorDetailDialog;
