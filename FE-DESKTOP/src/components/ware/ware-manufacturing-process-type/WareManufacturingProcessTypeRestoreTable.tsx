...
interface Props {
    ...
    onRestore: (item: WareManufacturingProcessType) => void;
    onDetail: (item: WareManufacturingProcessType) => void;
}

const WareManufacturingProcessTypeRestoreTable: React.FC<Props> = ({ page, limit, items, onRestore, onDetail }) => {
    return (
        <Table.ScrollArea
            borderWidth="1px"
            rounded="md"
...
export default WareManufacturingProcessTypeRestoreTable;