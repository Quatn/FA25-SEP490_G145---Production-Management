...
import { Button, Card, Heading, HStack, SimpleGrid, Stack, Text, Textarea } from "@chakra-ui/react"
    ...
    <Card.Root size="md" h="full">
      ...
      <Card.Body>
        ...
        <Stack mt={5}>
          ...
          <Textarea variant="subtle" value={ware?.note} placeholder={"Nhấn để nhập"} readOnly autoresize />
        </Stack>
      </Card.Body>
