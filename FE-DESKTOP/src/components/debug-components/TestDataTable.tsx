...
import useDataTable, { DataTableOptions } from "@/components/ui/data-table/hook";
...
const TestDataTableQueryInput = () => {
  logTimestamp("TestDataTableQueryInput: Start render")
  ...
  try {
    ...
    logTimestamp("TestDataTableQueryInput: Finished render")
  }
}
...
const TestDataTableEditCheckBox = () => {
  ...
  logTimestamp("TestDataTableEditCheckBox re-rendered")
...
const HoveredRowDisplay = () => {
  ...
  logTimestamp("HoveredRowDisplay re-rendered")
...
export default function TestDataTable() {
  const timestampAnchor = new Date()
  logTimestamp("TestDataTable: Start render", timestampAnchor, true)
  const memoDataOption = useMemo<DataTableOptions<Person>>(() => {
    return {
      data: defaultData,
  ...
  const dataTable = useDataTable(memoDataOption)
  logTimestamp("TestDataTable: Finished hook call", timestampAnchor, true)
  ...
  try {
    ...
    logTimestamp("TestDataTable: Finished render", timestampAnchor, true)
  }
}
