...
import { ManufacturingOrderCorrugatorProcessOperateTableProvider } from "@/context/manufacturing-order/manufacturingOrderCorrugatorProcessOperateTableContext";
          ...
          <Stack my={5} mx={5} gap={5}>
            <Box p={3} rounded={"md"} bg={"bg.muted"}>
              <DataTableProvider initialState={{ allowEdit: true }}>
                <ManufacturingOrderCorrugatorProcessOperateTableProvider>
                  <Stack>
