...
import { wareManufacturingProcessTypeAdminPrivileges } from "@/types/CascadingAccessPrivileges";
import { Box, Center, Spinner } from "@chakra-ui/react";

export default function WareManufacturingProcessTypeRestoreListLayout({
  children,
}: Readonly<{
