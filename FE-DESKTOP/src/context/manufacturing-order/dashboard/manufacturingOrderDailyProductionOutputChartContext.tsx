...
export function ManufacturingOrderDailyProductionOutputChartProvider(
...
function useStoreInstance() {
  ...
  if (!store) throw new Error("Must be used inside ManufacturingOrderDailyProductionOutputChartProvider");
  return store;
}
...
export const ManufacturingOrderDailyProductionOutputChartReducerStore = {
