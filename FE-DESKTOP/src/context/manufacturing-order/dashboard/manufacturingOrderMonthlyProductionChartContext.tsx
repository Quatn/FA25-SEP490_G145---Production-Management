...
export function ManufacturingOrderMonthlyProductionChartProvider(
...
function useStoreInstance() {
  ...
  if (!store) throw new Error("Must be used inside ManufacturingOrderMonthlyProductionChartProvider");
  return store;
}
...
export const ManufacturingOrderMonthlyProductionChartReducerStore = {
