...
export function ManufacturingOrderMonthlyDepartmentOutputsChartProvider(
...
function useStoreInstance() {
  ...
  if (!store) throw new Error("Must be used inside ManufacturingOrderMonthlyDepartmentOutputsChartProvider");
  return store;
}
...
export const ManufacturingOrderMonthlyDepartmentOutputsChartReducerStore = {
