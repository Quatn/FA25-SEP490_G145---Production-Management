...
export function ManufacturingOrderTrackPanelListProvider(
...
function useStoreInstance() {
  ...
  if (!store) throw new Error("Must be used inside ManufacturingOrderTrackPanelListProvider");
  return store;
}
...
export const ManufacturingOrderTrackPanelListReducerStore = {
